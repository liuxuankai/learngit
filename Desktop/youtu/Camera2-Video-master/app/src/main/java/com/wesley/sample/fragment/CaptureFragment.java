 ...
 */
public class CaptureFragment extends Camera2Fragment implements Camera2Listener, View.OnClickListener, RadioGroup.OnCheckedChangeListener {

    private String basePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/LipRecorder/AndroidWav/";
    protected MyPlayer mediaSingle;
...
//        mediaSingle = MediaPlayer.create(context, R.raw.signal);
        mediaSingle = new MyPlayer(basePath, fileName, numFre);
        return file;
    }
...
//                    mediaSingle.release();
    ...
    private void deleteFile(String name) {
        ...
        File txtFile = new File(basePath+experiment.getText() + "/"+name+".txt");
        wavFile.delete();
        mp4File.delete();
        txtFile.delete();
    }
        ...
        normalDialog.setPositiveButton("yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        moveFile(basePath, basePath+experiment.getText()+"/", lastFileName+".txt");
                    }
                });
