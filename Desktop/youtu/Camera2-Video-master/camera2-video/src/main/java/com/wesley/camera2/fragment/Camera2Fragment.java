...
//            Range<Integer>[] a = characteristics
//                    .get(CameraCharacteristics.CONTROL_AE_AVAILABLE_TARGET_FPS_RANGES);
//
//            for (Range<Integer> i : a) {
//                Log.i("Range: ",i.toString());
//            }
            ...
            recordUtil.createRecordInstance();
...
//            Range<Integer> range = new Range<Integer>(25, 25);
//            mPreviewBuilder.set(CaptureRequest.CONTROL_AE_TARGET_FPS_RANGE, range);
//            Log.i(TAG, "getSurfaces: " + mPreviewBuilder.get(CaptureRequest.CONTROL_AE_TARGET_FPS_RANGE));
    ...
    protected void setUpMediaRecorder() throws IOException {
        ...
        recordUtil.storeFile(file.getParent(), fileName);
        mCurrentFile = file;
        file.createNewFile();
...
//        mMediaRecorder.setVideoEncodingBitRate(10*1440*1080);
        mMediaRecorder.setVideoEncodingBitRate(30*640*480);
        mMediaRecorder.setVideoFrameRate(30);
        mMediaRecorder.setMaxDuration(mRecordTime * 1000);
//        Log.i(TAG, "setUpMediaRecorder: FrameRate 30" );
